...
export class AccountEntity {
  ...
  public withdraw(money: MoneyEntity, targetAccountId: AccountId): boolean {
    ...
    const withdrawal: ActivityEntity = new ActivityEntity(this.id, this.id, targetAccountId, new Date(), money);
  ...
  public deposit(money: MoneyEntity, sourceAccountId: AccountId): boolean {
    const deposite: ActivityEntity = new ActivityEntity(this.id, sourceAccountId, this.id, new Date(), money);


    this.activityWindow.addActivity(deposite);
